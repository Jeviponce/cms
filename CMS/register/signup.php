	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<form class="login100-form validate-form" method="POST" action="signup_query.php" autocomplete="off">
					...
					<input class="input100" type="hidden" id="pwd" name="pwd" value="<?php echo $randomPassword; ?>" readonly>
